...
pi.component.register('code',function(obj){
	var myEditArea = obj[0];
	var mode = obj.attr('data-pi-mode') || '';
	var style = obj.attr('data-pi-style') || 'chrome';
	var readOnly = obj.attr('data-pi-readonly') || false;
	var lines = obj.attr('data-pi-lines') || false;
