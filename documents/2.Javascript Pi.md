...
Tutti i nomi di variabile che iniziano con i "**:**" (due punti) sono nda considerarsi *riservati* e non vengono **MAI** passati nelle chiamate (che siano registrati o no):
