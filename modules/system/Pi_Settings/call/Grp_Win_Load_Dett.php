<?php
	...
	$del = '<td></td>';
	if($count_mod==0){
		$del ='<button class="red" onclick="pi.chk(\'Cancellare il gruppo?\').requestOnModal(\'mod_grp\',\'Grp_Del\')"><i18n>grp:iface:removeGroup</i18n></button>';
	}
	$fill = array();
	$fill['id'] = $id;
	...
	$out .='</table></div>';
	$footer = '<button class="red" onclick="pi.win.close()"><i18n>cancel</i18n></button>'.$del.'<button class="green" onclick="pi.requestOnModal(\'mod_grp\',\'Grp_Mod\')"><i18n>save</i18n></button>';
