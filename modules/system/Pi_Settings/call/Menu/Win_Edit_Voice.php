<?php
	...
	if($voice){ // sono in modifica
		...
		$footer .= '<button class="red" onclick="pi.chk(\'Eliminare la Voce del menu?\').requestOnModal(\'Mod_Voice\',\'Menu/Del_Voice\')"> <i18n>delete</i18n> </button>
		<button class="green" onclick="pi.requestOnModal(\'Mod_Voice\',\'Menu/Mod_Voice\')"> <i18n>save</i18n> </button>';
		$header = '<i18n>menu:iface:showDettVoice</i18n>';
	}else{ // sono in inserimento
		$footer .= '<button class="green" onclick="pi.requestOnModal(\'Mod_Voice\',\'Menu/Add_Voice\')"> <i18n>save</i18n> </button>';
