<?php
	...
	$out = '<div id="Win_Edit">
		<div class="focus purple">
			<i18n>db:conn:postgreInfo</i18n> '.$txtMod.'
			'.$oldID.'
		</div>
	...
	$footer = '<button class="red" onclick="pi.win.close();"> <i18n>cancel</i18n></button>'.$delButton.'<button class="green" onclick="pi.requestOnModal(\'Win_Edit\',\'DB/Save_PostgreSQL\')"><i18n>save</i18n></button>';
	
	$pr->addWindow(600,0,'<i18n>db:conn:postgre</i18n>',$out,$footer)->addScript('$("#WinEditFocus").focus();')->addFill('Win_Edit',$fill)->response();
?>