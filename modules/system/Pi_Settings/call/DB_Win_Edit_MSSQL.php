<?php
	...
	$out = '<div id="Win_Edit">
		<div class="focus purple">
			Sorgente dati MS SQLServer (usando i driver InnoDB)'.$txtMod.'
			'.$oldID.'
		</div>
	...
	$footer = '<button class="red" onclick="pi.win.close();"> Annulla</button>'.$delButton.'<button class="green" onclick="pi.requestOnModal(\'Win_Edit\',\'DB_Save_MSSQL\')">Salva</button>';
	
	$pr->addWindow(600,0,'Sorgente Dati MSSQL',$out,$footer)->addScript('$("#WinEditFocus").focus();')->addFill('Win_Edit',$fill)->response();
?>